...
function renderHome() {
  ...
  <section class="globe-sec" id="globeSec">
    <div class="globe-head">
      ...
      <p>Только страны, где жил род. Точки — места рождений и смертей, пунктир — путь от родителей к детям.</p>
    </div>
    <div class="globe-stage" id="globeStage">
      <div class="globe-legend"><b>золотой контур</b> — страна рода · точка — место · пунктир — переезд поколения · клик по точке — кто здесь жил</div>
